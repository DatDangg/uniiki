...
int main() {
    const std::vector<std::pair<std::string, std::string>> required = {
        ...
        {"bary", "bảy"}, {"bayr", "bảy"},
        {"haxy", "hãy"},
        {"cuar", "của"}, {"giuwx", "giữa"}, {"quar", "quả"},
        {"dduocwj", "được"}, {"dduocj", "được"},
        {"muonwj", "mượn"}, {"muonj", "mượn"}, {"muoons", "muốn"}, {"cuoons", "cuốn"},
        {"luongwj", "lượng"}, {"luongj", "lượng"}, {"luoongs", "luống"}, {"cuoongf", "cuồng"},
        {"suowng", "sương"}, {"huongwr", "hưởng"}, {"huongr", "hưởng"},
